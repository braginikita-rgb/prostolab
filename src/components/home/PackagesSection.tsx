        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-8 items-start">
                    {/* Start */}
                    <motion.div
                        initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.8, ease: "easeOut" }}
                        style={{ opacity: 0 }}
                        className="p-8 rounded-[40px] flex flex-col h-full relative border-orange-500/30 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1),0_10px_40px_-15px_rgba(249,115,22,0.1)] bg-white transform scale-105 z-10 transition-shadow duration-300 md:hover:-translate-y-2 hover:shadow-[0_30px_80px_-10px_rgba(249,115,22,0.4)]"
                    >
                    ...
                    {/* Business (Popular) */}
                    <motion.div
                        initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.8, ease: "easeOut", delay: 0.1 }}
                        style={{ opacity: 0 }}
                        className="bg-white/60 backdrop-blur-md p-8 rounded-[40px] flex flex-col h-full hover:bg-white transition-colors duration-300 border border-slate-200 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1),0_10px_40px_-15px_rgba(249,115,22,0.1)] md:hover:-translate-y-1 hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.05),0_20px_60px_-15px_rgba(249,115,22,0.3)]"
                    >
                    ...
                    {/* Premium */}
                    <motion.div
                        initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
                        style={{ opacity: 0 }}
                        className="bg-white/60 backdrop-blur-md p-8 rounded-[40px] flex flex-col h-full hover:bg-white transition-colors duration-300 border border-slate-200 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1),0_10px_40px_-15px_rgba(249,115,22,0.1)] md:hover:-translate-y-1 hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.05),0_20px_60px_-15px_rgba(249,115,22,0.3)]"
                    >
