                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="prose prose-invert prose-lg text-slate-400 space-y-8">
                                ...
                                <section>
                                    ...
                                    <p>
                                        Мы используем файлы cookie для обеспечения корректной работы сайта prostolab.org, а также для аналитики, чтобы понимать, как пользователи взаимодействуют с нашим сайтом, и улучшать пользовательский опыт.
                                    </p>
                                    <p className="mt-4">
